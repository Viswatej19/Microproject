...
const dbName='details';//db name where hospital and ventilator collections are there
const vent ="ventilatordetails";//collection name of ventilator details
const hosp='hospitaldetails';//collection name of the hospital details
let db
